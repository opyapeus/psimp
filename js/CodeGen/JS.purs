...
import CodeGen.JS.Common (foreignIdentToJS, identToJS, properToJS, psstringToJS)
...
impToJS mod =
  ...
  foreignBinds =
    map (\f -> J.VarAssign (identToJS f) (J.ForeignAccessor (foreignIdentToJS f) (J.Var foreignIdent)))
      mod.moduleForeigns
